...
var showAlert = function showAlert(type, msg) {
  // hide other alerts
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // right at the begining of the body
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicnV0aC1jb2hlbjg5IiwiYSI6ImNsMDhicHYwZTAxeWUza3F1aHpqcGp4djYifQ.aKSKkgyvvrMIEveBJu_w4g'; // The Map object represents the map on the page
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // 1) Add Marker
    // New Marker
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'bottom' // Add Marker to the map
      // Sets the location of the anchor on map

    }).setLngLat(loc.coordinates).addTo(map); // 2) Add popup
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; // every async function returns a promise
